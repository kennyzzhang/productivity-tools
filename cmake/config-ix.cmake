...
if(APPLE)
  ...
  list_intersect(CILKSCALE_SUPPORTED_ARCH
    ...
    CILKTOOLS_COMMON_SUPPORTED_ARCH)
  list_intersect(CILKPRACE_SUPPORTED_ARCH
    ALL_CILKPRACE_SUPPORTED_ARCH
    CILKTOOLS_COMMON_SUPPORTED_ARCH)
  list_intersect(CILKPISTON_SUPPORTED_ARCH
    ALL_CILKPISTON_SUPPORTED_ARCH
    CILKTOOLS_COMMON_SUPPORTED_ARCH)
  ...
  filter_available_targets(CILKPISTON_SUPPORTED_ARCH ${ALL_CILKPISTON_SUPPORTED_ARCH})
endif()
...
if (CILKPRACE_SUPPORTED_ARCH AND
    OS_NAME MATCHES "Linux|Darwin|FreeBSD")
  set(CILKTOOLS_HAS_CILKPRACE TRUE)
else()
  set(CILKTOOLS_HAS_CILKPRACE FALSE)
endif()

if (CILKPISTON_SUPPORTED_ARCH AND
    OS_NAME MATCHES "Linux|Darwin|FreeBSD")
  set(CILKTOOLS_HAS_CILKPISTON TRUE)
else()
  set(CILKTOOLS_HAS_CILKPISTON FALSE)
endif()
